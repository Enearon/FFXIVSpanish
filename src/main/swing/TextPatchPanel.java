...
import main.thread.ReplaceThread;
import main.thread.RollbackThread;
import main.util.EXDFUtil;
...
public class TextPatchPanel extends JFrame implements ActionListener {
	...
	private static String title = "Aplicar Parche";
	private JLabel title_lable = new JLabel(title);
	private Dimension dimension;
	private JButton bootButton = new JButton("Inicio Rápido");
	private JButton configButton = new JButton("Volver");
	private JButton closeButton = new JButton("x");
	private JPanel titlePanel = new JPanel();
	private JPanel bodyPanel = new JPanel();
	public JButton replaceButton = new JButton("Traducir");
	public JButton rollbackButton = new JButton("Restaurar");
	private JLabel menuText = new JLabel("by GPointChen | Traducción by Enearon",  SwingConstants.RIGHT);
	...
	public TextPatchPanel() {
		...
		// 設置按鈕
		this.configButton.setBounds(210, 0, 55, 30);
		...
		this.replaceButton.setFont(new Font("Microsoft Yahei", 0, 15));
		...
		this.rollbackButton.setFont(new Font("Microsoft Yahei", 0, 15));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.replaceButton) {
			...
			System.out.println("Ruta del juego: " + path);
			System.out.println("Idioma original: " + slang);
			System.out.println("Idioma objetivo: " + dlang);
			System.out.println("Idioma del archivo: " + flang);
			System.out.println("Sustituir fuente: " + rfont);
			System.out.println("Sustituir texto: " + rtext);
			log.config("Ruta del juego: " + path);
			log.config("Idioma original: " + slang);
			log.config("Idioma objetivo: " + dlang);
			log.config("Idioma del archivo: " + flang);
			log.config("Sustituir fuente: " + rfont);
			log.config("Sustituir texto: " + rtext);
			...
			if (isFFXIVFloder(path)) {
				...
				JOptionPane.showMessageDialog(null, "<html><body>Por favor selecciona la ruta del juego:<br />FINAL FANTASY XIV ONLINE</body></html>", "Error de Ruta", 0);
