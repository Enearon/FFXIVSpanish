...
import main.util.HexUtils;
import main.util.res.Config;

public class ConfigApplicationPanel extends JFrame implements ActionListener {
	
	private static Point origin = new Point();
	private static String title = "Traductor FFXIV Esp";
	...
	private JLabel pathLable = new JLabel("Ruta");
	private JTextField pathField = new JTextField();
	private JButton pathButton = new JButton(".");
	
	private JLabel sLangLable = new JLabel("Idioma");
	private JComboBox<String> sLangLableVal;
	
	private JLabel dLangLable = new JLabel("Cambiar el Idioma");
	private JComboBox<String> dLangLableVal;
	
	// added
	private JLabel fLangLable = new JLabel("Ficheros");
	private JComboBox<String> fLangLableVal;
	
	private JCheckBox rFont = new JCheckBox("Cambiar Tipografía");
	private JCheckBox rText = new JCheckBox("Reemplazar Texto");
	private JButton detailButton = new JButton("Opciones");
	
	private JButton configButton = new JButton("Confirmar");
	...
	public ConfigApplicationPanel() {
		...
		this.fLangLableVal.addItem("Japonés");
		this.fLangLableVal.addItem("Inglés");
		this.fLangLableVal.addItem("Alemán");
		this.fLangLableVal.addItem("Francés");
		this.fLangLableVal.addItem("Chino Simplificado");
		...
		this.sLangLableVal.addItem("Japonés");
		this.sLangLableVal.addItem("Inglés");
		this.sLangLableVal.addItem("Alemán");
		this.sLangLableVal.addItem("Francés");
		this.sLangLableVal.addItem("Chino Simplificado");
		...
		this.dLangLableVal.addItem("Chino Simplificado");
		this.dLangLableVal.addItem("Chino Tradicional");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.pathButton) {
			...
			pathChooser.setDialogTitle("Selecciona el directorio principal del juego");
			...
			if (returnVal == 0) {
				...
				if (isFFXIVFloder(filePath)) {
					...
					JOptionPane.showMessageDialog(null, "<html><body>Por favor, selecciona el directorio raíz del juego:<br />FINAL FANTASY XIV ONLINE</body></html>", "Error de Ruta", 0);
				} 
			} 
		} 
		...
		if (e.getSource() == this.configButton) {
			...
			if (isFFXIVFloder(path)) {
				...
				JOptionPane.showMessageDialog(null, "<html><body>Por favor selecciona el directorio correcto:<br />FINAL FANTASY XIV ONLINE</body></html>", "Error de Ruta", 0);
			} 
		} 
